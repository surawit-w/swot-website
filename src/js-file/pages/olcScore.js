...
export default class olcScore extends Component {
        ...
        for(let i = 0; i < optionResult.length; i++) {
            switch(optionResult[i].phraseScore) {
                case "OLC1":
                    for(let j = 0; j < optionResult[i].option.length; j++) {
                        console.log(optionResult[i].option[j].optionScore)
                        await this.state.OLC1Score.push(parseFloat(optionResult[i].option[j].optionScore).toFixed(2))
                    }
                    await this.setState({
                ...
                case "OLC2":
                    for(let j = 0; j < optionResult[i].option.length; j++) {
                        console.log(optionResult[i].option[j].optionScore)
                        await this.state.OLC2Score.push(parseFloat(optionResult[i].option[j].optionScore).toFixed(2))
                    }
                    await this.setState({
                ...
                case "OLC3":
                    for(let j = 0; j < optionResult[i].option.length; j++) {
                        console.log(optionResult[i].option[j].optionScore)
                        await this.state.OLC3Score.push(parseFloat(optionResult[i].option[j].optionScore).toFixed(2))
                    }
                    await this.setState({
                ...
                case "OLC4":
                    for(let j = 0; j < optionResult[i].option.length; j++) {
                        console.log(optionResult[i].option[j].optionScore)
                        await this.state.OLC4Score.push(parseFloat(optionResult[i].option[j].optionScore).toFixed(2))
                    }
                    await this.setState({
                ...
                case "OLC5":
                    for(let j = 0; j < optionResult[i].option.length; j++) {
                        console.log(optionResult[i].option[j].optionScore)
                        await this.state.OLC5Score.push(parseFloat(optionResult[i].option[j].optionScore).toFixed(2))
                    }
                    await this.setState({
    ...
    renderPhrase1Result = (e, i) => (
        <div style={{display:'flex', flexDirection:'row'}}>
            ...
            <div style={{flex: '0 0 10%'}}>
                <select ref={`olc1${i+1}`} id={`olc1${i+1}`}  name="cars" onChange={this.handleChange}>
    ...
    renderPhrase2Result = (e, i) => (
        <div style={{display:'flex', flexDirection:'row'}}>
            ...
            <div style={{flex: '0 0 10%'}}>
                <select ref={`olc2${i+1}`} id={`olc2${i+1}`} name="cars" onChange={this.handleChange}>
                    <option value="1" >1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
    ...
    renderPhrase3Result = (e, i) => (
        <div style={{display:'flex', flexDirection:'row'}}>
            ...
            <div style={{flex: '0 0 10%'}}>
                <select ref={`olc3${i+1}`} id={`olc3${i+1}`} name="cars" onChange={this.handleChange}>{console.log(e)}
                    <option value="1" >1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
    ...
    renderPhrase4Result = (e, i) => (
        <div style={{display:'flex', flexDirection:'row'}}>
            ...
            <div style={{flex: '0 0 10%'}}>
                <select ref={`olc4${i+1}`} id={`olc4${i+1}`} name="cars" onChange={this.handleChange}>
                    <option value="1" >1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
    ...
    renderPhrase5Result = (e, i) => (
        <div style={{display:'flex', flexDirection:'row'}}>
            ...
            <div style={{flex: '0 0 10%'}}>
                <select ref={`olc5${i+1}`} id={`olc5${i+1}`} name="cars" onChange={this.handleChange}>
                    <option value="1" >1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
    ...
    handleSubmit = async() => {
        let totalScorePhrase1, totalScorePhrase2, totalScorePhrase3, totalScorePhrase4, totalScorePhrase5
        totalScorePhrase1 = totalScorePhrase2 = totalScorePhrase3 = totalScorePhrase4 = totalScorePhrase5 = 0.00
		let { OLC1Result, OLC2Result, OLC3Result, OLC4Result, OLC5Result, OLC1Score, OLC2Score, OLC3Score, OLC4Score, OLC5Score, finalScore, firstSubmit } = this.state
		...
		console.log(optionResult)
				...
				switch (i) {
					case 0:
						for (j = 0; j < OLC1Result.length; j++) {
							let optionBarScore = (Object.values(this.refs)).splice(0, OLC1Result.length)
							console.log(optionBarScore)
							console.log(optionBarScore[j].value);
							// console.log(this.optionBarScore)
							totalScorePhrase1 = (parseFloat(totalScorePhrase1) + (parseFloat(optionBarScore[j].value)*parseFloat(OLC1Score[j]))).toFixed(2)
					...
					case 1:
						for (j = 0; j < OLC2Result.length; j++) {
							...
							let optionBarScore = (Object.values(this.refs)).splice(OLC1Result.length, OLC2Result.length)
							console.log(optionBarScore[j]);
							// console.log(weaknessScore[j],parseFloat(Object.values(this.refs)[j].value))
							totalScorePhrase2 = (parseFloat(totalScorePhrase2) + (parseFloat(optionBarScore[j].value)*parseFloat(OLC2Score[j]))).toFixed(2)
					...
					case 2:
						...
						let optionBarScore = (Object.values(this.refs)).splice(OLC1Result.length + OLC2Result.length, OLC3Result.length)
						console.log(optionBarScore);
						totalScorePhrase3 = (parseFloat(totalScorePhrase3) + (parseFloat(optionBarScore[j].value)*parseFloat(OLC3Score[j]))).toFixed(2)
					...
					case 3:
						...
						let optionBarScore = (Object.values(this.refs)).splice(OLC1Result.length + OLC2Result.length + OLC3Result.length, OLC4Result.length)
						console.log(optionBarScore);
						totalScorePhrase4 = (parseFloat(totalScorePhrase4) + (parseFloat(optionBarScore[j].value)*parseFloat(OLC4Score[j]))).toFixed(2)
					...
					case 4:
						for (j = 0; j < OLC5Result.length; j++) {
							...
							let optionBarScore = (Object.values(this.refs)).splice(OLC1Result.length + OLC2Result.length + OLC3Result.length + OLC4Result.length, OLC5Result.length)
							console.log(optionBarScore);
							totalScorePhrase5 = (parseFloat(totalScorePhrase5) + (parseFloat(optionBarScore[j].value)*parseFloat(OLC5Score[j]))).toFixed(2)
			...
			finalScore.sort(function(a,b){return Math.abs(b.totalScore) - Math.abs(a.totalScore)})
			...
			console.log(OLC1isTrue2, OLC2isTrue2, OLC3isTrue2, OLC4isTrue2, OLC5isTrue2)
        ...
        <div>
            ...
            { this.state.OLC1isTrue && 
                <div style={{ margin: '60px', backgroundColor: '#0a0a',border: 'solid 2px #000',borderRadius: '8px'}}>
                    <div style={{margin: '36px'}}>{this.state.OLC1Result.map(this.renderPhrase1Result)}</div>
                </div>
            } { this.state.OLC2isTrue && 
                <div style={{ margin: '60px', backgroundColor: '#0a0a',border: 'solid 2px #000',borderRadius: '8px'}}>
                    <div style={{margin: '36px'}}>{this.state.OLC2Result.map(this.renderPhrase2Result)}</div>
                </div>
            } { this.state.OLC3isTrue && 
                <div style={{ margin: '60px', backgroundColor: '#0a0a',border: 'solid 2px #000',borderRadius: '8px'}}>
                    <div style={{margin: '36px'}}>{this.state.OLC3Result.map(this.renderPhrase3Result)}</div>
                </div>
            } { this.state.OLC4isTrue && 
                <div style={{ margin: '60px', backgroundColor: '#0a0a',border: 'solid 2px #000',borderRadius: '8px'}}>
                    <div style={{margin: '36px'}}>{this.state.OLC4Result.map(this.renderPhrase4Result)}</div>
                </div>
            } { this.state.OLC5isTrue && 
                <div style={{ margin: '60px', backgroundColor: '#0a0a',border: 'solid 2px #000',borderRadius: '8px'}}>
                    <div style={{margin: '36px'}}>{this.state.OLC5Result.map(this.renderPhrase5Result)}</div>
                </div>
            }
