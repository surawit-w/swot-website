...
export default class scorePage extends Component {
    ...
    componentDidMount = async() => {
        ...
        opportunityResult = await swotQuizResult[2]
        threatResult = await swotQuizResult[3]
    ...
    handleSubmit = () => {
        ...
        for (var i = 0; i < 4; i++) {
            ...
            switch (i) {
                case 0:
                    for (j = 0; j < strengthResult.length; j++) {
                    ...
                    break;
                case 1:
                    for (j = 0; j < weaknessResult.length; j++) {
                    ...
                    break;
      case 2:
        for (j = 0; j < opportunityResult.length; j++) {
        ...
        break
      case 3:
        for (j = 0; j < threatResult.length; j++) {
