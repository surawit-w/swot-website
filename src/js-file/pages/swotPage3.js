...
import Strength from "../components/strength3"
import Weakness from "../components/weakness3"
import Opportunity from "../components/opportunity3"
...
class swotPage3 extends Component {
    ...
    myThreatCallback = async (dataFromChild) => {
        console.log(dataFromChild)
        await this.state.result_arr.push(dataFromChild)
        localStorage.setItem('swot-result3', JSON.stringify(this.state.result_arr))
        this.props.history.push('/swot-score3');
        window.scrollTo(0, 0);
    }
    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="header"><h1 style={{ fontFamily: "bold" }}>วิเคราะห์ SWOT ธุรกิจการค้า</h1></div>
                ...
                <div className="column-divider">
                    {isStrength && <Strength callbackFromParent={this.myStrengthCallback}/>}
