...
export default class threat extends Component {
  ...
  render() {
    return (
          <div className="wrapper-swot-form threat" style={{ border: 'solid 2px', padding: '60px', borderRadius: '20px'}}>
            <h2 style={{fontFamily: 'regular'}}>T: Threat (อุปสรรค)</h2>
            ...
            <Form style={{ fontFamily: 'light'}}>
                <fieldset>
                    ...
                    <Form.Label as="legend" style={{fontSize: '18px', fontFamily: 'regularItalic'}}>
                        อุปสรรคของทางร้าน (เลือกข้อที่ถูกต้องที่สุด)
                    </Form.Label>
                    <Col>
                        <Form.Check
