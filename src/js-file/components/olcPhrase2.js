...
export default class olcPhrase2 extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            textOptionArr: ['การมีลูกค้าให้การตอบรับธุรกิจหรือบริการอย่างรวดเร็วทำให้มียอดขายและมีกำไรที่เพิ่มสูงขึ้น',
            ...
            option_arr: [],
            score_arr: [0.10, 0.15, 0.10, 0.10, 0.10, 0.05, 0.10, 0.20, 0.05, 0.05],
            left_option_arr: [],
